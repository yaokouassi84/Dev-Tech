                        ...
                        <div class="wow fadeInUp" data-wow-delay="0.2s">
                            ...
                            <!-- <form action="Erreur404" method="Post"> -->
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" name="prenom" id="email" placeholder="Votre prénom">
                                    ...
                                    <div class="col-12">
                                        <div class="form-floating">
                                            <textarea class="form-control" placeholder="Votre message ici" name="msg" id="message" style="height: 150px"></textarea>
            ...
            <div class="container py-5 px-lg-5">
                <div class="row gy-5 gx-4 pt-5">
                    ...
                    <div class="col-md-6 col-lg-3">
                        ...
                        <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>62730 Marck, France, Europe</p>
                    ...
                    <div class="col-md-6 col-lg-4 mt-lg-n5">
                        <div class="bg-light rounded" style="padding: 30px;">
                            ...
                            <textarea name="sms" class="form-control border-0 mb-2" rows="2" placeholder="Message"></textarea>
                            <button class="btn btn-primary w-100 py-2">Valider</button>
                        </div>
                    </div>
                </div>
            </div>
