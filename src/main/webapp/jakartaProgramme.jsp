...
<head>
    <meta charset="utf-8">
    <title>Prgramme Jakarta EE</title>
                ...
                <div class="container my-5 py-5 px-lg-5">
                    <div class="row g-5 pt-5">
                        <div class="col-12 text-center text-lg-start">
                            <h1 class="display-4 text-white animated slideInLeft">Programme de Java EE { Jakarta EE }</h1>
        ...
        <div class="container-xxl py-5">
            <div class="container px-lg-5">
                <div class="section-title position-relative text-center mx-auto mb-5 pb-4 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                    <h1 class="mb-3">Nos Chapitres de formation</h1>
                    <p class="mb-1">Cette formation est dédiée aux débutants</p>
                </div>
                <div class="row g-4">
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="team-item border-top border-5 border-primary rounded shadow overflow-hidden">
                            <div class="text-center p-4">
                               <img class="img-fluid rounded-circle mb-4" src="img/JavaChapitre.png" alt="">
                                <h5 class="fw-bold mb-1">Chapitre 1</h5>
                                <a href="<c:url value="JakartaChapitre1" />"><small>Introduction Jakarta EE</small></a>
                            </div>                            
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="team-item border-top border-5 border-primary rounded shadow overflow-hidden">
                            <div class="text-center p-4">
                                ...
                                <a href="<c:url value="Chapitre2" />"><small>Chapitre 2</small></a>
                            </div>                            
                        </div>
                    </div>
