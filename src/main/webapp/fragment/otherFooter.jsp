                ...
                <div class="row gy-5 gx-4 pt-5">                   
                    ...
                    <div class="col-md-6 col-lg-4 mt-lg-n5">
                        <div class="bg-light rounded" style="padding: 30px;">
                        	...
                        	<form action="SendAvis" method="POST">
                            <input type="text" name="nomAvis" class="form-control border-0 py-2 mb-2" placeholder="Nom">
                            <input type="text" name="prenomAvis" class="form-control border-0 py-2 mb-2" placeholder="Prénom">
                            <input type="email" name="email" class="form-control border-0 py-2 mb-2" placeholder="Email">
                            <textarea name="message" class="form-control border-0 mb-2" rows="2" placeholder="Tapez votre message ici"></textarea>
                            <button class="btn btn-primary w-100 py-2">Valider l'avis</button>
                            </form>
                            <div>${msa}</div>
                        </div>
                    </div>
